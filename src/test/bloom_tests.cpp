...
{
    std::string strSecret = std::string("8tA7BK23K8wyQ4fMGiHXD6pFB4haDiKMdPz88Cg7NxZfLkjoRnFaVCU");
...
BOOST_AUTO_TEST_CASE(rolling_bloom)
{
    ...
    // Run test_kusacoin with --log_level=message to see BOOST_TEST_MESSAGEs:
