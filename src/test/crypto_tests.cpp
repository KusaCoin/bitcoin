...
BOOST_AUTO_TEST_CASE(sha256_testvectors) {
    ...
    TestSHA256("As Kusacoin relies on 80 byte header hashes, we want to have an example for that.",
               "9116fb0135d9dfda4626abee1edabcd5f979ded66db00da5fdaa467e469a5a0a");
