...
BOOST_AUTO_TEST_CASE(rpc_rawsign)
{
    ...
    r = CallRPC(std::string("createrawtransaction ")+prevout+" "+
      "{\"VzmRA5t3m7WdgUCPLVtLVDqFE2edNqr1AP6FDR\":11}");
    std::string notsigned = r.get_str();
    std::string privkey1 = "\"bnoCGRywA5XpkAUBDJS3ZiMtzDHas9JGYmH34GLcdwUChuH95wB3pg8r\"";
    std::string privkey2 = "\"bnoCGQp2qZ4aL6p4tuRPCgdaDfbwtMKspAM4Dsh5h2VWy1DaK3JVboMP\"";
...
BOOST_AUTO_TEST_CASE(json_parse_errors)
{
    ...
    BOOST_CHECK_THROW(ParseNonRFCJSONValue("1.0]"), std::runtime_error);
    // KUSA addresses should fail parsing
