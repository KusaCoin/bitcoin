...
#ifndef KUSACOIN_WALLET_WALLET_H
#define KUSACOIN_WALLET_WALLET_H
...
public:
     ...
     * on this kusacoin node, and set to 0 for transactions that were created
...
#endif // KUSACOIN_WALLET_WALLET_H
