...
private:
    ...
    QString formatTxAmount(const TransactionRecord *wtx, bool showUnconfirmed=true, KusacoinUnits::SeparatorStyle separators=KusacoinUnits::separatorStandard) const;
...
#endif // KUSACOIN_QT_TRANSACTIONTABLEMODEL_H
